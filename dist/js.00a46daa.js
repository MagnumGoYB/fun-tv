  ...
  */
    ...
    MgTz: [
      function (require, module, exports) {
        ...
        var preloadImages = function preloadImages() {
          ...
          return new Promise(function (resolve) {
            ;(0,
            _imagesLoaded.default)(document.querySelectorAll(selector), resolve)
          })
        }
      ...
      function (require, module, exports) {
        ...
        var ContentPage = function ContentPage(el) {
          ...
          this.DOM.galleryItems =
            this.DOM.gallery.querySelectorAll('.gallery-figure')
    ...
    evi4: [
      function (require, module, exports) {
        ...
        var _contentPage = _interopRequireDefault(require('./content-page'))
        ...
        var MenuItem = /*#__PURE__*/ (function () {
          function MenuItem(el, galleryEl, contentEl) {
            ...
            this.DOM.galleryItems = _toConsumableArray(
    ...
    ECw1: [
      function (require, module, exports) {
        ...
        var MenuController = /*#__PURE__*/ (function () {
          function MenuController(el) {
            ...
            this.DOM.galleries = _toConsumableArray(
              document.querySelectorAll('.bg-gallery-wrap > .bg-gallery')
            ) // Content DOM

            this.DOM.pagePreview = document.querySelector('.page-preview')
            this.DOM.content = _toConsumableArray(
              this.DOM.pagePreview.querySelectorAll('.content')
            ...
            this.DOM.el
              ...
              .forEach(function (item, pos) {
                _this.menuItems.push(
                  new _menuItem.default(
                    item,
                    _this.DOM.galleries[pos],
                    _this.DOM.content[pos]
                  )
                )
              })
            this.init()
            ...
            },
            {
              ...
              value: function showContent(menuItem) {
                ...
                _gsap.gsap
                  ...
                  .addLabel('showPageContent', timelineDefaults.duration * 0.1)
                  .to(
                    menuItem.contentPage.DOM.backCtrl,
                    {
                      startAt: {
                        x: '50%'
                      },
                  ...
                  .to(
                    [menuItem.contentPage.DOM.titleInner],
                    {
                      ...
                      onStart: function onStart() {
                        _gsap.gsap.set([menuItem.contentPage.DOM.title], {
                          opacity: 1,
                          stagger: -0.06
                        })
                      },
                  ...
                  .to(
                    menuItem.contentPage.DOM.galleryItems,
                    {
                      startAt: {
                        y: '100%',
              ...
              value: function showMenu(menuItem) {
                ...
                ;(0, _utils.scrollIt)(0, 300, 'easeOutQuad', function () {
                  _gsap.gsap
                    ...
                    .addLabel('showMenuItems', timelineDefaults.duration * 0.1)
                    .to(
                      _this5.menuItems.map(function (item) {
                        return item.DOM.title
                      }),
                      {
                        y: '0%',
      ...
      { './utils': 'MgTz', gsap: 'TpQl', './menu-item': 'evi4' }
    ],
    QvaY: [
      function (require, module, exports) {
        'use strict'
        ...
        var _menuController = _interopRequireDefault(
        ...
        Promise.all([(0, _utils.preloadImages)('.gallery-figure-img')]).then(
          function () {
      ...
      { './cursor': 'LMRJ', './menu-controller': 'ECw1', './utils': 'MgTz' }
    ]
  },
  {},
  ['QvaY'],
